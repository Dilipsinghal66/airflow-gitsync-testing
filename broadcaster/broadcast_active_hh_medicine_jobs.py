...
def get_patient_ids():
    try:
        ...
        filter_active_patient_query = "select id from patient_profile where status=4 and client_code in ('HH','AZ') and new_chat=1 and id in (" + ','.join(
