...
def vital_intense_managed():
    try:
        ...
        for patient_id in patient_id_distinct:
            ...
            if no_0f_rows == 5:
                ...
                if 70 <= avg <= 140:
                    ...
                    patient_id_list_dont_change.append(patient_id)
            else:
                patient_id_list_dont_change.append(patient_id)
        ...
        for patient_id in patient_id_list_on_managed:
            if patient_id not in patient_id_list_dont_change:
        ...
        log.info("patient_id_list_for_intense " + str(patient_id_list_for_intense))
