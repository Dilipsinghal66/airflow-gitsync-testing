...
from jobs.sync_webinars.sync_webinars_jobs import initializer
...
config_var = Variable.get('webinar_sync', None)
...
sync_webinars_dag = DAG(
    dag_id="sync_webinars_dag",
...
sync_doctor_code_task = PythonOperator(
    task_id="sync_webinars",
    task_concurrency=1,
    python_callable=initializer,
    dag=sync_webinars_dag,
    op_kwargs={},
