...
from jobs.sync_doctor_codes.syncDoctorCodesFromGsheetJob_na import initializer
...
config_var = Variable.get('doctor_sync_config_na', None)
...
sync_doctor_codes_na_dag = DAG(
    dag_id="sync_doctor_codes_na_dag",
...
sync_doctor_code_task = PythonOperator(
    task_id="sync_doctor_codes_na",
    task_concurrency=1,
    python_callable=initializer,
    dag=sync_doctor_codes_na_dag,
    op_kwargs={},
