...
from jobs.sync_doctor_codes.syncDoctorCodesFromGsheetJob_hh import initializer
...
config_var = Variable.get('doctor_sync_config_hh', None)
...
sync_doctor_codes_hh_dag = DAG(
    dag_id="sync_doctor_codes_hh_dag",
