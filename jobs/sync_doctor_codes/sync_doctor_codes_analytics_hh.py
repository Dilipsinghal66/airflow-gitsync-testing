...
from jobs.sync_doctor_codes.sync_doctor_codes_analytics_job_hh import initializer
...
config_var = Variable.get('doctor_sync_analytics_hh_config', None)
...
sync_doctor_codes_hh_analytics_dag = DAG(
    dag_id="sync_doctor_codes_analytics_hh_dag",
...
sync_doctor_code_hh_analytics_task = PythonOperator(
    task_id="sync_doctor_codes_hh_analytics",
    task_concurrency=1,
    python_callable=initializer,
    dag=sync_doctor_codes_hh_analytics_dag,
    op_kwargs={},
