...
from jobs.sync_doctor_codes.syncDoctorCodesFromGsheetJob_cc import initializer
...
config_var = Variable.get('doctor_sync_config_cc', None)
...
sync_doctor_codes_cc_dag = DAG(
    dag_id="sync_doctor_codes_cc_dag",
...
sync_doctor_code_task = PythonOperator(
    task_id="sync_doctor_codes_cc",
    task_concurrency=1,
    python_callable=initializer,
    dag=sync_doctor_codes_cc_dag,
    op_kwargs={},
