...
from jobs.sync_doctor_codes.syncDoctorCodesFromGsheetJob_nd import initializer
...
config_var = Variable.get('doctor_sync_config_nd', None)
...
sync_doctor_codes_nd_dag = DAG(
    dag_id="sync_doctor_codes_nd_dag",
...
sync_doctor_code_task = PythonOperator(
    task_id="sync_doctor_codes_nd",
    task_concurrency=1,
    python_callable=initializer,
    dag=sync_doctor_codes_nd_dag,
    op_kwargs={},
